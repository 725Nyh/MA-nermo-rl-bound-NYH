            ...
            try:
                while (args.n_episodes == -1 or episode_num < args.n_episodes):
                    ...
                    if real_time_rounded == 0.7:
                        radius_maze = 0.7
                        velocity_maze = 0.15
                    if real_time_rounded == 7:
                        velocity_maze = 0.15
                        radius_maze = -0.3
                    if real_time_rounded == 21.5:
                        radius_maze = 0.7
                        velocity_maze = 0.2
                    if real_time_rounded == 26:
                        radius_maze = -0.3
                        velocity_maze = 0.2
                    if real_time_rounded == 32.0:
                        radius_maze = 100
                        velocity_maze = 0.2
                    # observation[15] = (1/radius_maze)
                    ...
                    if done:
                        ...
                        if show_eval_plots:
                            ...
                            x_label = "Time [sec]"
                            smoothed_only = True
                            # roll = [info["current_roll"] for info in episode_infos]
                            # np.savetxt("roll.csv",roll,delimiter=",")
                            # pitch = [info["current_pitch"] for info in episode_infos]
                            # np.savetxt("pitch.csv",pitch,delimiter=",")
                            # yaw = [info["current_yaw"] for info in episode_infos]
                            # np.savetxt("yaw.csv",yaw,delimiter=",")
                            # rare_orientation_roll = [info["rare_orientation_roll"] for info in episode_infos]
                            # np.savetxt("rare_orientation_roll.csv",rare_orientation_roll,delimiter=",")
                            # rare_orientation_pitch = [info["rare_orientation_pitch"] for info in episode_infos]
                            # np.savetxt("rare_orientation_pitch.csv",rare_orientation_pitch,delimiter=",")
                            # rare_orientation_yaw = [info["rare_orientation_yaw"] for info in episode_infos]
                            # np.savetxt("rare_orientation_yaw.csv",rare_orientation_yaw,delimiter=",")
                            ...
                            # plot_metrics_over_episode(
                            #     episode_infos=episode_infos,
                            #     metrics=["cummulative_angle_displacement"],
                            #     x_scale_factor=x_scale_factor,
                            #     # caution: positions are negative
                            #     x_label=x_label,
                            #     y_label=None,
                            ...
                            # if info.get("current_yaw") is not None:                    
                            #     angle_metrics = ["current_yaw"]
                            #     metric_labels = ["current_yaw angle"]
                            #     show_legend = True
                            #     plot_metrics_over_episode(
                            #         episode_infos=episode_infos,
                            #         metrics=angle_metrics,
                            #         x_scale_factor=x_scale_factor,  
                            #         x_label=x_label,
                            #         y_label="current_yaw angle [rad]",
                            #         figure_name=f"current_yaw{episode_num}",
                            #         metric_labels=metric_labels,
                            #         show_legend=show_legend,
                            #         smoothing_window=None,
                            #         smoothed_only=not smoothed_only,
                            ...
                            # plot_metrics_over_episode(
                            #     episode_infos=episode_infos,
                            #     metrics=["relative_foot_positions"], #only z-positions
                            #     x_scale_factor=x_scale_factor,
                            #     #caution: positions are negative
                            #     x_label="x-Position [m]",
                            #     y_label="y-Position [m]",
                            #     figure_name=f"relative_foot_positions_episode_{episode_num}",
                            #     show_legend=True,
                            #     smoothing_window=None,
                            #     smoothed_only=not smoothed_only,
                            #     csv_path=training_path,
                            ...
                            # plot_metrics_over_episode(
                            #     episode_infos=episode_infos,
                            #     metrics=["site_positions"], #only z-positions
                            #     x_scale_factor=x_scale_factor,
                            #     #caution: positions are negative
                            #     x_label="time",
                            #     y_label="y-Position [m]",
                            #     figure_name=f"site_positions_episode_{episode_num}",
                            #     show_legend=True,
                            #     smoothing_window=None,
                            #     smoothed_only=not smoothed_only,
                            #     csv_path=training_path,
